...
(function(root, factory) {
    ...
    Lang.prototype.getLocale = function() {
        return this.locale || curentLocale || this.fallback;
    };
    ...
    Lang.prototype._parseKey = function(key, locale) {
        ...
        return {
            with_locale: locale + '.' + key,
            with_fallback: this.getFallback() + '.' + key,
    ...
    Lang.prototype._getMessage = function(key, locale) {
        ...
        let valueOnLocale = this.byStringPath(this.messages, key.with_locale);

        if (typeof valueOnLocale === 'string') {
            return valueOnLocale;
        }

        let valueOnFallbackLocale = this.byStringPath(this.messages, key.with_fallback);
        if (typeof valueOnFallbackLocale === 'string') {
            return valueOnFallbackLocale;
        }
    ...
    Lang.prototype.byStringPath = function(entityObj, searchPath) {
